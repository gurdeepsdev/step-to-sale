...
//     dots: count > 1,
//     infinite: count > 1,
//     speed: 1200, // 👈 slower slide animation
//     slidesToShow: Math.min(3, count), // 👈 show up to 6 banners
//     slidesToScroll: 1,
//     autoplay: count > 1,
//     autoplaySpeed: 8000, // 👈 8 seconds (slow & smooth)
//     arrows: count > 1,
//     pauseOnHover: true, // 👈 important
//     pauseOnFocus: true,
//     prevArrow: <PrevArrow />,
//     nextArrow: <NextArrow />,
//   });
...
//     slidesToScroll: 1,
//     autoplay: count > 1,
//     autoplaySpeed: 6000, // 👈 slower for mobile
//     arrows: count > 1,
//     pauseOnHover: true,
//     prevArrow: <PrevArrow />,
//     nextArrow: <NextArrow />,
  ...
  const settings = {
    ...
    responsive: [
      ...
      },
      {
        breakpoint: 9999,
        settings: {
          slidesToShow: Math.min(3, banners.length),
        },
      },
    ],
  };
