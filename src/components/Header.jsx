...
import { Wallet } from "lucide-react"; // or use any icon library you like
...
import { FaRegBell, FaBars, FaRegShareSquare,FaWallet } from "react-icons/fa";
...
<div className="relative">
  ...
  {showWallet && (
    <div className="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 bg-white shadow-lg rounded-md px-4 py-2 text-sm text-gray-700 z-10 whitespace-nowrap">
      Balance: {balance}
    </div>
  )}
</div>
  ...
  <div className="relative">
    <button
      onClick={toggleNotificationsSidebar}
      className="w-10 h-10 rounded-full hover:bg-gray-100 flex items-center justify-center text-2xl relative"
    >
      <FaRegBell />
  ...
  <div className="relative">
    <button
      onClick={() => setShowWallet((prev) => !prev)} // toggle wallet balance
      className="w-10 h-10 rounded-full hover:bg-gray-100 flex items-center justify-center text-xl"
    >
      <FaWallet />
    </button>

    {/* Wallet balance dropdown (optional) */}
    {showWallet && (
      <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-md px-4 py-2 text-sm text-gray-700 z-10">
        Balance: {balance}
      </div>
    )}
  </div>
    ...
    >
      ...
      <div className="text-center mt-4">
        ...
        <div className="flex justify-center py-2 bg-[#244856] text-center">
          ...
          <a href="/Coupontopcodes" className="text-white hover:text-red-500 px-2 text-[10px] sm:px-2  lg:px-6 md:px-6 sm:text-sm md:px-3 md:text-lg lg:text-lg">
            Coupon Codes
          </a>
          <a   href="/Deals"
           className="text-white hover:text-red-500 px-2 text-[10px] sm:px-2 lg:px-6 md:px-6 sm:text-sm md:px-3 md:text-lg lg:text-lg">
