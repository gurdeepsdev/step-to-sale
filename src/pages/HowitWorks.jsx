...
const OfferCard = () => {
  ...
  return (
    ...
    <div className="relative w-full">
      {/* Background Image */}
      <img src="/img/Refer.webp" alt="Refer and Earn" className="w-full h-auto" />
...
<div className="flex flex-col items-center text-center">
    ...
    <img src="/img/share.webp" className="mt-2 w-[1003px] mb-2 md:mb-8 lg:mb-8" alt="Share" />
</div>
