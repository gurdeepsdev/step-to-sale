  ...
  return (
    ...
    <div className="min-h-screen w-full bg-white text-gray-800">
      ...
      <header className="bg-[#244856] text-white">
        <div className="mx-auto max-w-7xl px-2 py-2 flex flex-col md:flex-row md:items-center gap-6">
          <img
        src={branimg}
alt="Mattress Firm logo"
            className="mx-auto md:mx-0 h-20 w-auto object-contain"
          />

          <div className="flex-1 text-center md:text-left">
            <h1 className="text-2xl md:text-3xl font-semibold">
            {brandtitle}          Coupons And Offers - July 2025         
            </h1>
